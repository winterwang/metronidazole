---
title: "Metronidazole : Side effects and Safety"
...
A:link {
 COLOR: #993300	 /*The color of the link*/
}
A:visited {
...
1. **Metronidazole (MNZ)** has been broadly prescribed as therapy for **$H. pylori$** eradication worldwide. 

2. Second line regimen using MNZ is covered under national health insurance in Japan.

3. Eradication rate :^1 <br> **60.5%** for PPI + AMPC + CLA (PAC) | **98.3%** for PPI + AMPC + MNZ (PAM) 

4. Resistance rate of CLA in Japanese children is reported to be more than **40%**.^2

> MNZ **$\Longrightarrow$** **Possibly carcinogenic to human (2B)** 
> <br>**ヒトに対する発がん性が疑われる**
> <br><cite>[by International Agency for Research on Cancer, IARC in 1987](http://monographs.iarc.fr/ENG/Monographs/suppl7/index.php)</cite>
...
_Genetic damage_      |**Negative**| 2000    |[**Touati _et al_**](http://jac.oxfordjournals.org/content/46/6/987.long)
...
--- 
[Lack of evidence for cancer due to use of metronidazole. N Engl J Med. 1979;301:519–522. ](http://www.nejm.org/doi/full/10.1056/NEJM197909063011003)**ヒトでの追跡研究**
<div class="centered">
...
1. Brain/nerve related: seizures^1 , aseptic meningitis^2 , encephalopathy^3 .<br> $\Longrightarrow$ Prolonged use of MNZ. (脳神経系)
2. Gastrointestinal tract related: nausea, occasionally vomiting, diarrhea.^4 <br> $\Longrightarrow$ Daily dose $\geq$ 2250 mg. (消化器系)
3. Skin eruption^5 , pancreatitis^6 . (皮疹，膵炎)
...
---
**Recommended regimens in [UK](https://www.evidence.nhs.uk/formulary/bnfc/current/1-gastro-intestinal-system/13-antisecretory-drugs-and-mucosal-protectants/helicobacter-pylori-infection)** **(イギリスの小児除菌推奨レジメ)**
...
**<br>北米・ユーロッパ小児除菌アルゴリズム："**
<div class="centered">
<IMG SRC="Guideline.png" style="width:px;height:700px">
</div>
